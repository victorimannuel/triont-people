...
TRANSLATIONS = {
    ...
    "Auto Sync API": {"id": "Auto Sync API", "idc": "Auto Sync API"},
    "dates added via": {"id": "hari libur ditambahkan via", "idc": "hari libur ditambahin via"},
    ...
    "Reset filter": {"id": "Reset filter", "idc": "Reset filter"},
    "Clear filters": {"id": "Hapus filter", "idc": "Hapus filter"},
    "All Status": {"id": "Semua status", "idc": "Semua status"},
    "Department Head": {"id": "Kepala Departemen", "idc": "Kepala Divisi"},
    "All notification statuses": {"id": "Semua status notifikasi", "idc": "Semua status notif"},
    "Active notifications": {"id": "Notifikasi aktif", "idc": "Notif aktif"},
    "Disabled notifications": {"id": "Notifikasi nonaktif", "idc": "Notif nonaktif"},
    "Search leave types...": {"id": "Cari jenis cuti...", "idc": "Cari jenis cuti..."},
    "Search departments...": {"id": "Cari departemen...", "idc": "Cari divisi..."},
    "Search company...": {"id": "Cari perusahaan...", "idc": "Cari company..."},
    "Search name or email...": {"id": "Cari nama atau email...", "idc": "Cari nama atau email..."},
    ...
    "Add Approval Workflow Level": {"id": "Tambah Level Alur Approval", "idc": "Tambah Level Approval"},
    "Delete Approval Workflow Level": {"id": "Hapus Level Alur Approval", "idc": "Hapus Level Approval"},
    "OTP Verification Failed": {"id": "Verifikasi OTP Gagal", "idc": "Verifikasi OTP Gagal"},
    "OTP Verification Locked": {"id": "Verifikasi OTP Dikunci", "idc": "Verifikasi OTP Dikunci"},
    "Password OTP Failed": {"id": "OTP Password Gagal", "idc": "OTP Password Gagal"},
    "Password OTP Locked": {"id": "OTP Password Dikunci", "idc": "OTP Password Dikunci"},
    "Security: Forbidden Access": {"id": "Keamanan: Akses Ditolak", "idc": "Keamanan: Akses Ditolak"},
    "Security: Suspicious Probe Blocked": {"id": "Keamanan: Probe Mencurigakan Diblokir", "idc": "Keamanan: Probe Mencurigakan Diblokir"},
    "Anonymous Events": {"id": "Event Anonim", "idc": "Event Anonim"},
    "Blocked Events": {"id": "Event Diblokir", "idc": "Event Diblokir"},
    "Result": {"id": "Hasil", "idc": "Hasil"},
    "Security Events Today": {"id": "Event Keamanan Hari Ini", "idc": "Event Keamanan Hari Ini"},
    "Security Logs": {"id": "Log Keamanan", "idc": "Log Keamanan"},
    "Security events, blocked probes, and anonymous request failures separated from operational audit logs.": {"id": "Event keamanan, probe yang diblokir, dan kegagalan request anonim dipisahkan dari audit log operasional.", "idc": "Event keamanan, probe yang diblokir, dan request anonim gagal dipisah dari audit log operasional."},
    ...
    "Back to Dashboard": {"id": "Kembali ke Dashboard", "idc": "Balik ke Dashboard"},
    "Go Back": {"id": "Kembali ke Halaman Sebelumnya", "idc": "Balik ke Halaman Sebelumnya"},
    "Reload Page": {"id": "Muat Ulang Halaman", "idc": "Refresh Halaman"},
    "Access Denied": {"id": "Akses Ditolak", "idc": "Akses Ditolak"},
    "Page Not Found": {"id": "Halaman Tidak Ditemukan", "idc": "Halaman Ga Ditemukan"},
    "Internal Server Error": {"id": "Terjadi Kesalahan Server", "idc": "Server Lagi Bermasalah"},
    "You do not have permission to access this resource.": {"id": "Maaf, Anda tidak memiliki izin untuk mengakses halaman atau fitur ini. Silakan hubungi Administrator jika Anda merasa ini adalah kesalahan.", "idc": "Maaf, akun kamu ga punya izin buat buka halaman atau fitur ini. Coba hubungi Admin ya."},
    "The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.": {"id": "Halaman yang Anda tuju tidak ditemukan atau telah dipindahkan ke tautan lain.", "idc": "Halaman yang kamu cari ga ada atau link-nya udah dipindahin."},
    "Something went wrong on our end. Please try again later or contact support if the problem persists.": {"id": "Terjadi kendala saat memproses permintaan Anda. Sistem telah mencatat kendala ini.", "idc": "Ada masalah di server pas proses permintaan kamu. Coba lagi bentar ya."},
    "Quick Links": {"id": "Navigasi Cepat", "idc": "Link Cepat"},
    "Apply Leave": {"id": "Ajukan Cuti", "idc": "Ajukan Cuti"},
    ...
    "Select All": {"id": "Pilih Semua", "idc": "Pilih Semua"},
    "Deselect all": {"id": "Batalkan pilihan", "idc": "Batalin pilihan"},
    "item terpilih": {"id": "item dipilih", "idc": "item dipilih"},
    "items selected": {"id": "item dipilih", "idc": "item dipilih"},
    "Pulihkan Terpilih": {"id": "Pulihkan Terpilih", "idc": "Balikin Terpilih"},
    "Arsipkan Terpilih": {"id": "Arsipkan Terpilih", "idc": "Arsip Terpilih"},
    "Buka Arsip Terpilih": {"id": "Buka Arsip Terpilih", "idc": "Buka Arsip Terpilih"},
    "Hapus Terpilih": {"id": "Hapus Terpilih", "idc": "Hapus Terpilih"},
    "Aksi Massal": {"id": "Aksi Massal", "idc": "Aksi Massal"},
    "Pilih setidaknya satu item terlebih dahulu.": {"id": "Pilih setidaknya satu item terlebih dahulu.", "idc": "Pilih minimal satu item dulu ya."},
    "Konfirmasi Tindakan": {"id": "Konfirmasi Tindakan", "idc": "Konfirmasi Tindakan"},
    "Pastikan tindakan Anda sudah sesuai": {"id": "Pastikan tindakan Anda sudah sesuai", "idc": "Pastikan tindakan Anda sudah sesuai"},
    "Item yang Dipilih": {"id": "Item yang Dipilih", "idc": "Item yang Dipilih"},
    "Apakah Anda yakin ingin melanjutkan tindakan ini?": {"id": "Apakah Anda yakin ingin melanjutkan tindakan ini?", "idc": "Yakin mau lanjutin tindakan ini?"},
    "Ya, Lanjutkan": {"id": "Ya, Lanjutkan", "idc": "Ya, Lanjut"},
    "Hapus Karyawan": {"id": "Hapus Karyawan", "idc": "Hapus Karyawan"},
    "Pulihkan Karyawan": {"id": "Pulihkan Karyawan", "idc": "Balikin Karyawan"},
    "Hapus Jenis Cuti": {"id": "Hapus Jenis Cuti", "idc": "Hapus Jenis Cuti"},
    "Arsipkan Jenis Cuti": {"id": "Arsipkan Jenis Cuti", "idc": "Arsip Jenis Cuti"},
    "Pulihkan Jenis Cuti": {"id": "Pulihkan Jenis Cuti", "idc": "Balikin Jenis Cuti"},
    "Hapus Departemen": {"id": "Hapus Departemen", "idc": "Hapus Divisi"},
    "Pulihkan Departemen": {"id": "Pulihkan Departemen", "idc": "Balikin Divisi"},
    "Hapus Perusahaan": {"id": "Hapus Perusahaan", "idc": "Hapus Company"},
    "Pulihkan Perusahaan": {"id": "Pulihkan Perusahaan", "idc": "Balikin Company"},
    "Hapus Level Approval": {"id": "Hapus Level Approval", "idc": "Hapus Level Approval"},
    "Hapus Riwayat Approval": {"id": "Hapus Riwayat Approval", "idc": "Hapus Riwayat Approval"},
    "Pulihkan Riwayat Approval": {"id": "Pulihkan Riwayat Approval", "idc": "Balikin Riwayat Approval"},
    "Arsipkan Riwayat Approval": {"id": "Arsipkan Riwayat Approval", "idc": "Arsip Riwayat Approval"},
    "Buka Arsip Riwayat Approval": {"id": "Buka Arsip Riwayat Approval", "idc": "Buka Arsip Riwayat Approval"},
    "Batalkan Pengajuan Cuti": {"id": "Batalkan Pengajuan Cuti", "idc": "Batalin Pengajuan Cuti"},
    "Reset Link Kalender": {"id": "Reset Link Kalender", "idc": "Reset Link Kalender"},
    "Ya, Hapus": {"id": "Ya, Hapus", "idc": "Ya, Hapus"},
    "Ya, Arsipkan": {"id": "Ya, Arsipkan", "idc": "Ya, Arsipkan"},
    "Ya, Pulihkan": {"id": "Ya, Pulihkan", "idc": "Ya, Balikin"},
    "Ya, Batalkan": {"id": "Ya, Batalkan", "idc": "Ya, Batalin"},
    "Ya, Reset Link": {"id": "Ya, Reset Link", "idc": "Ya, Reset Link"},
    "Ya, Buka Arsip": {"id": "Ya, Buka Arsip", "idc": "Ya, Buka Arsip"},
    ...
    "Role is not allowed.": {"id": "Role tidak diizinkan.", "idc": "Role ga diizinkan."},
    "Only super admins can manage super admin accounts.": {"id": "Hanya super admin yang dapat mengelola akun super admin.", "idc": "Cuma super admin yang bisa manage akun super admin."},
    "Custom Domain Guide": {"id": "Panduan Domain Custom", "idc": "Panduan Custom Domain"},
    "Setup guide": {"id": "Panduan setup", "idc": "Panduan setup"},
    "Connect Company Domain": {"id": "Hubungkan Domain Perusahaan", "idc": "Konek Domain Company"},
    "Use CNAME so People appears on the client's own domain.": {"id": "Gunakan CNAME agar People tampil di domain milik client.", "idc": "Pake CNAME biar People tampil di domain client sendiri."},
    "1. Choose subdomain": {"id": "1. Pilih subdomain", "idc": "1. Pilih subdomain"},
    "Example:": {"id": "Contoh:", "idc": "Contoh:"},
    "2. Add DNS CNAME": {"id": "2. Tambahkan DNS CNAME", "idc": "2. Tambahin DNS CNAME"},
    "3. Wait for propagation": {"id": "3. Tunggu propagasi", "idc": "3. Tunggu propagasi"},
    "Usually a few minutes up to 24 hours. Do not use redirects; CNAME keeps client domain visible.": {"id": "Biasanya beberapa menit hingga 24 jam. Jangan gunakan redirect; CNAME menjaga domain client tetap terlihat.", "idc": "Biasanya beberapa menit sampai 24 jam. Jangan pake redirect; CNAME bikin domain client tetap kelihatan."},
    "4. Test and activate": {"id": "4. Tes dan aktifkan", "idc": "4. Tes dan aktifin"},
    "Use the test button to verify DNS and HTTPS status before activating the domain for the client.": {"id": "Gunakan tombol test untuk verifikasi status DNS dan HTTPS sebelum domain client diaktifkan.", "idc": "Pake tombol test buat cek DNS dan HTTPS sebelum domain client diaktifin."},
    "Custom domain status": {"id": "Status domain custom", "idc": "Status custom domain"},
    "Check whether the client domain already points to People and serves HTTPS correctly.": {"id": "Cek apakah domain client sudah mengarah ke People dan HTTPS berjalan dengan benar.", "idc": "Cek domain client udah ngarah ke People dan HTTPS-nya bener atau belum."},
    "Ready": {"id": "Siap", "idc": "Siap"},
    "Partial": {"id": "Sebagian", "idc": "Sebagian"},
    "Not ready": {"id": "Belum siap", "idc": "Belum siap"},
    "Not tested": {"id": "Belum dites", "idc": "Belum dites"},
    "Client domain": {"id": "Domain client", "idc": "Domain client"},
    "You may paste a full URL; only the hostname will be checked.": {"id": "Anda boleh menempelkan URL lengkap; hanya hostname yang akan dicek.", "idc": "Boleh paste URL penuh; yang dicek cuma hostname-nya."},
    "Test domain": {"id": "Tes domain", "idc": "Tes domain"},
    "Domain": {"id": "Domain", "idc": "Domain"},
    "DNS target": {"id": "Target DNS", "idc": "Target DNS"},
    "Expected target": {"id": "Target yang diharapkan", "idc": "Target yang harusnya"},
    "Resolved IPs": {"id": "IP hasil resolve", "idc": "IP hasil resolve"},
    "Target IPs": {"id": "IP target", "idc": "IP target"},
    "HTTPS app check": {"id": "Cek aplikasi HTTPS", "idc": "Cek app HTTPS"},
    "Response": {"id": "Respons", "idc": "Respons"},
    "No HTTPS response yet.": {"id": "Belum ada respons HTTPS.", "idc": "Belum ada respons HTTPS."},
    "Domain is required.": {"id": "Domain wajib diisi.", "idc": "Domain wajib diisi."},
    "Domain is invalid.": {"id": "Domain tidak valid.", "idc": "Domainnya ga valid."},
    "Please enter a domain name, not an IP address.": {"id": "Masukkan nama domain, bukan alamat IP.", "idc": "Masukin nama domain, bukan IP address."},
    "Domain resolves to a private or unsafe IP address.": {"id": "Domain mengarah ke alamat IP private atau tidak aman.", "idc": "Domain ngarah ke IP private atau unsafe."},
    "Custom domain is not ready yet.": {"id": "Domain custom belum siap.", "idc": "Custom domain belum siap."},
    "Domain looks ready.": {"id": "Domain terlihat siap.", "idc": "Domain keliatan siap."},
    "Domain is partially ready. Check the details below.": {"id": "Domain sebagian sudah siap. Periksa detail di bawah.", "idc": "Domain sebagian udah siap. Cek detail di bawah."},
    "Test Custom Domain": {"id": "Tes Domain Custom", "idc": "Tes Custom Domain"},
    ...
    "Previous Year": {"id": "Tahun Sebelumnya", "idc": "Tahun Sebelumnya"},
    "Next Year": {"id": "Tahun Berikutnya", "idc": "Tahun Selanjutnya"},
    "Primary Color": {"id": "Warna Utama", "idc": "Warna Utama"},

...
TRANSLATIONS = {
    ...
    "Restore": {"id": "Pulihkan", "idc": "Pulihkan"},
    "Restore Company": {"id": "Pulihkan Perusahaan", "idc": "Balikin Company"},
    "Restore Department": {"id": "Pulihkan Departemen", "idc": "Balikin Divisi"},
    "Restore Employee": {"id": "Pulihkan Karyawan", "idc": "Balikin Karyawan"},
    ...
    "Deleted": {"id": "Dihapus", "idc": "Dihapus"},
    "Delete company?": {"id": "Hapus perusahaan?", "idc": "Hapus company?"},
    "Delete department?": {"id": "Hapus departemen?", "idc": "Hapus divisi?"},
